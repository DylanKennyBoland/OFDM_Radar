...
% Add Cylic Prefix (CP):
G = 1/4; % the fraction of the OFDM symol which is used as a guard interval
cpLen1 = G*L; % the cyclic prefix (CP) length for DFT-S case...
cpLen2 = G*N;
...
% Channel parameters: CHANGE HOW YOU MODEL THE NOISE; use AWGN instead and
% use the channel SNR as the metric...
