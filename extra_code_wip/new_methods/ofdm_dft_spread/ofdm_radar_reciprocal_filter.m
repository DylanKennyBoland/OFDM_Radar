%% Trying to implement the Reciprocal Filtering Approach:
...
% in the above paper.
K = 52; % The number of subcarriers being used
M = 14; % The frame size
...
cpLen = round(G*K); % The cyclic prefix (CP) length
...
delay = 7; % The delay of the received signal (r) in units of samples
...
nu = -300:25:300; % The Greek letter "Nu", which looks like a 'v', is standing for the frequency of the E.M. wave...
...
title("\fontsize{14}\fontname{Georgia}Reciprocal Filter (\tau = " + delay + ", f_{D} = " + fD + " Hz, \sigma^{2} = " + noisedBW + " dBW, " + modOrder + "-" + modulationType + ", N = " + K + ", M = " + M + ", G = " + G + ")");
