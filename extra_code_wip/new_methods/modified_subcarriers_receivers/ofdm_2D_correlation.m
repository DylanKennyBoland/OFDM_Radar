...
title("\fontsize{14}\fontname{Georgia}Correlation-based Estimation (\tau = " + delay + ", \itf_{D}\rm\bf = " + fD + " Hz, \sigma^{2}_{N} = " + noisedBW + " dBW, " + modOrder + "-" + modulationType + ", K = " + K + ", M = " + M + ", G = " + G + ")");
