...
% in the above paper. We are also testing its effectiveness with some of
...
delayLabels(~(mod(delayVec, 5) == 0)) = ""; % If value in vector is NOT divisble by 10, leave blank
...
title("\fontsize{14}\fontname{Georgia}Reciprocal Filter ("+IEEEstandard + ", \tau = " + delay + ", f_{D} = " + fD + " Hz, \sigma^{2} = " + noisedBW + " dBW, " + modOrder + "-" + modType + ", N = " + N + ", M = " + M + ", G = " + G + ")");
