%% %% This is a copy of a script in the correlation-based_methods folder. It is being used for comparison here::
...
% Trying to implement the reciprocal filtering approach that is discussed
% in the above paper.
...
for block = 1:M
    ...
    sm = 1./conj(s(1+L*n: L*n + L)); % The signal sm
    sm(isinf(sm)) = 0;
...
title("\fontsize{14}\fontname{Georgia}Reciprocal Filter (Delay = " + delay + ", f_{D} = " + fD + " Hz, Noise = " + noisedBW + " dBW, " + modOrder + "-" + modulationType + ", K = " + K + ", M = " + M + ", G = " + G + ")");
